(function () {
  const MESSENGER = "https://m.me/Kajun.bohol.panglao";
  const LEAD_MIN = 45;
  const SLOTS = ["11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00", "18:30", "19:00", "19:30", "20:00", "20:30", "21:00", "21:30", "22:00", "22:30"];
  ...
  function render() {
    ...
    if (totalEl) {
      totalEl.hidden = !has;
      totalEl.textContent = "Est. " + money(total()) + " + 5% service";
    }
    renderLines();
    markAdds();
    renderDock();
